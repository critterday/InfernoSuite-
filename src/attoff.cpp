...
struct ATTOFFWidget : ModuleWidget {
	ATTOFFWidget(ATTOFF* module) {
		...
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(40.176, 19.425)), module, ATTOFF::OFF1_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(19.887, 19.69)), module, ATTOFF::AFF1_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(39.61, 32.351)), module, ATTOFF::OFF2_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(19.51, 32.615)), module, ATTOFF::AFF2_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(39.798, 42.446)), module, ATTOFF::OFF3_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(18.896, 42.71)), module, ATTOFF::AFF3_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(39.893, 54.711)), module, ATTOFF::OFF4_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(18.99, 54.975)), module, ATTOFF::AFF4_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(39.893, 67.919)), module, ATTOFF::OFF5_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(18.99, 68.184)), module, ATTOFF::AFF5_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(39.987, 81.411)), module, ATTOFF::OFF6_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(19.085, 81.676)), module, ATTOFF::AFF6_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(40.176, 94.997)), module, ATTOFF::OFF7_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(19.274, 95.262)), module, ATTOFF::AFF7_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(40.081, 108.583)), module, ATTOFF::OFF8_PARAM));
		addParam(createParamCentered<RoundBlackKnob>(mm2px(Vec(19.179, 108.848)), module, ATTOFF::AFF8_PARAM));

		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(5.849, 19.624)), module, ATTOFF::IN1_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(5.283, 32.55)), module, ATTOFF::IN2_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(5.472, 42.645)), module, ATTOFF::IN3_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(5.566, 54.91)), module, ATTOFF::IN4_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(5.566, 68.118)), module, ATTOFF::IN5_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(5.661, 81.61)), module, ATTOFF::IN6_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(5.849, 95.196)), module, ATTOFF::IN7_INPUT));
		addInput(createInputCentered<PJ301MPort>(mm2px(Vec(5.755, 108.782)), module, ATTOFF::IN8_INPUT));

		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(54.992, 19.425)), module, ATTOFF::OUT1_OUTPUT));
		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(54.426, 32.351)), module, ATTOFF::OUT2_OUTPUT));
		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(54.615, 42.446)), module, ATTOFF::OUT3_OUTPUT));
		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(54.709, 54.711)), module, ATTOFF::OUT4_OUTPUT));
		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(54.709, 67.919)), module, ATTOFF::OUT5_OUTPUT));
		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(54.804, 81.411)), module, ATTOFF::OUT6_OUTPUT));
		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(54.992, 94.997)), module, ATTOFF::OUT7_OUTPUT));
		addOutput(createOutputCentered<PJ301MPort>(mm2px(Vec(54.898, 108.583)), module, ATTOFF::OUT8_OUTPUT));
	}
};
